...
| [Checkers AI](https://github.com/dippy2214/Checkers-AI) | November 2024 | C#, Unity | This project is a checkers AI made by implementing a monte-carlo search tree, with some additional optimisations to improve performance in the end games. I found the development process very interesting, and it taught me a lot about the value of decoupling data from the UI. |
...
| Project | Completion Date | Tools | Project description |
| :-----: | :-------------: | :---: | :-----------------: |
| [Software Rasteriser](https://github.com/dippy2214/Rasteriser) | June 2025 | C++, Windows API | This project is a software rasteriser with 0 dependancies made in C++ as a windows 32 app.
| [The Wiimote Project](https://github.com/dippy2214/The-Wiimote-Project) | January 2025 | C++, Windows API, (C#, .Net) | This project is an application which can connect to a wii remote via a bluetooth connection and emulate keyboards inputs based on the wiimotes button presses, motion controls or IR pointer. The program manages the bluetooth connection, decoding the binary data the wii remote sends through its reports, and is coded soley in C++ using the windows API. |
| [LLVM Compiler](https://github.com/dippy2214/MyLanguage2) | December 2024 | C++, CMake, LLVM | This project involved researching how to use LLVM to create a compiler for a programming language, and how to make that work in C++. It includes a tokeniser, parser, and functions as a very basic JIT compiler for LLVM's kalidescope language.
