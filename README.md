...
| [Checkers AI](https://github.com/dippy2214/Checkers-AI) | November 2023 | C#, Unity | This project was a checkers AI made by implementing a monte-carlo search tree, with some additional optimisations to improve performance in the end games. I found the development process very interesting, and the value of decoupling data from the UI was essential (and caused me to have to restart the project from scratch the first time round) |
...
| [Checkers AI](https://github.com/dippy2214/Checkers-AI) | November 2023 | C#, Unity | This project was a checkers AI made by implementing a monte-carlo search tree, with some additional optimisations to improve performance in the end games. I found the development process very interesting, as I made the project with the data highly coupled to the UI first, and had to remake it again while decoupling the data to make it more easily accessible for the AI. |
