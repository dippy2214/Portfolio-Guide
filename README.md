...
| [Xbox Controller Emulator](https://github.com/dippy2214/Xbox-Controller-Mouse-and-Keyboard-Emulator) | June 2024 | C++, XInput | This project is similar to the wiimote project, albeit at a higher level, connecting to an xbox controller and using it to emulate keyboard and mouse inputs by making use of Microsoft's XInput API. |
